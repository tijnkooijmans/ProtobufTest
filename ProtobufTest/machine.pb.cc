        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_state:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::machine::MachineStatus_State_IsValid(value)) {
            set_state(static_cast< ::machine::MachineStatus_State >(value));
          } else {
