...
class MachineStatus : public ::google::protobuf::Message {
 public:
  ...
  // optional .machine.MachineStatus.State state = 4 [default = IDLE];
  inline bool has_state() const;
  inline void clear_state();
  static const int kStateFieldNumber = 4;
  inline ::machine::MachineStatus_State state() const;
  inline void set_state(::machine::MachineStatus_State value);
...
inline ::machine::MachineStatus_State MachineStatus::state() const {
  return static_cast< ::machine::MachineStatus_State >(state_);
}
inline void MachineStatus::set_state(::machine::MachineStatus_State value) {
  assert(::machine::MachineStatus_State_IsValid(value));
  set_has_state();
  state_ = value;
}
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::machine::MachineStatus_State>() {
  return ::machine::MachineStatus_State_descriptor();
}
